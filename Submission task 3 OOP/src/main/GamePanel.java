...
public class GamePanel extends JPanel {
    ...
    JButton bt1 = new JButton(), bt2 = new JButton(), bt3 = new JButton(), bt4 = new JButton(), bt5 = new JButton(), bt6 = new JButton(), bt7 = new JButton(), bt8 = new JButton(), bt9 = new JButton(), bt10 = new JButton(), bt11 = new JButton(), bt12 = new JButton(), bt13 = new JButton(), bt14 = new JButton(), bt15 = new JButton(), bt16 = new JButton(), btStart, btRestart, btQuit, btBack, btScoreBoard, btMusic;
    ...
    public GamePanel() {
        ...
        this.setLayout(null); //gör att vi behöver sätta bounds på allt själva
    ...
    private void setUpPanelComponents() {
        ...
        btMusic = new JButton("<html><font size='+1' face='x12y16pxMaruMonica'>Music OFF</font></html>");
        btMusic.setBounds(screenWidth / 2 - 60, screenHeight - 35, 120, 25);
        this.add(btMusic);
        btMusic.addActionListener(bh);
    ...
    private void setUpStartScreen() {
        ...
        btScoreBoard.setBounds(screenWidth / 2 - 60, screenHeight / 2 + borderSize, 110, 25);
        startScreen.add(btScoreBoard);
